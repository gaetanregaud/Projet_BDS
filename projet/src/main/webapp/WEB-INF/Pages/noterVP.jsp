	    ...
	    <section id="notationvp">
    		...
    		<div id="infoVP">
    			<fieldset>
    				...
    				<input type="hidden" id="id_vp" value="${pratiquer.vp.identifiant}"/>
    				<input type="hidden" id="id_equipeSport" value="${pratiquer.equipesport.id_equipeSport}"/>
    		...
    		<div id="evalutation">
    			<form>
	    			...
	    			<input type="hidden" id="id_etudiant" value="${user_id}"/>
