...
<body>
	...
	<section>
		<h2>AS ${equipeSportVp.equipesport.nom_sport}
			(${equipeSportVp.equipesport.nom_equipeSport})</h2>
		<div id="fiche_vp">
			<c:if test="${user_id != null}">
				...
				<div id="photo_vp">
					<c:if test="${equipeSportVp.photo.isEmpty()}">
						<img src="IMAGE/photo/etudiant/admin.jpg" width="180px"
							height="180px">
					</c:if>
					<c:if test="${!equipeSportVp.photo.isEmpty()}">
						<img src="IMAGE/photo/etudiant/${equipeSportVp.photo}.jpg"
		...
		<div id="presentation_equipesport">
			...
			<div id="fleche"></div>
			<p id="presentation">${equipeSportVp.equipesport.description_equipeSport}
			<p>
				<c:if
					test="${user_id == equipeSportVp.id_etudiant && user_type.equals('vp')}">
